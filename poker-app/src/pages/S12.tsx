...
const examples: HandExample[] = [
  ...
  { tag: "Call vs jam", tagVariant: "call", board: <>963 two-tone</>, holeCards: <>44<C>♣</C> · Jam</>, desc: "9-high · two-tone · 44♣ · jam", verdict: "agree", verdictText: "System agrees", system: "Pure call. Neither range hits board. Must defend reasonable chunk.", solver: "Pure call. Confirms." },
