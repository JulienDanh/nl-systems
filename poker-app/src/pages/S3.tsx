...
const examples: HandExample[] = [
  { tag: "Fold", tagVariant: "fold", board: <>K<S>♠</S> 7<H>♥</H> 7<H>♥</H></>, desc: "K-high · paired · two-tone · 63o", verdict: "agree", verdictText: "System agrees", system: "Paired → evaluate king. 63o: no high card, no 3-straight, no BDFD. Pure fold.", solver: "~25% fold. A-high pure, Q-high ~pure, J-high starts folding. 98/86/65 (3-straight) pure. BDFD plays but worst (42s, 52s) fold." },
  { tag: "Defend", tagVariant: "call", board: <>A42 two-tone · J9<H>♥</H></>, desc: "A-high · two-tone · J9♥", verdict: "agree", verdictText: "System agrees", system: "Ignore ace/deuce. Key=4. Gutshots (3x,5x) pure. Worst contain 7 (97,T7). J9♥ high enough → pure play.", solver: "3x/5x pure calls. 97/T7 pure folds. 6 outcompetes 7. J9♥ pure confirmed." },
  { tag: "Fold", tagVariant: "fold", board: <>K<S>♠</S> 6<H>♥</H> 2<H>♥</H></>, desc: "K-high · two-tone · Q3 no spade", verdict: "agree", verdictText: "System agrees", system: "Key=6. Double-unders to 6 have gutshots (43,54,53) → pure calls. Folds from over-unders (73,83,93). Q3 no spade = fold.", solver: "Dense fold in over-unders. 73 with spade still folds. 75 (3-straight) pure. BDFDs pure on two-tone." },
  { tag: "Defend", tagVariant: "call", board: <>K<S>♠</S> Q<H>♥</H> 8<C>♣</C></>, desc: "KQ8 · rainbow · 76o", verdict: "agree", verdictText: "System agrees", system: "Key=8 (high). Double-unders fold — but 76 has 3-straight → pure play. 97 (over-under, 3-straight) pure. Double-overs (T9,J9,JT) pure.", solver: "Double-unders to 8 heavily folded. 76 pure. All 3-to-flush playable on rainbow (premium). Double-overs to 8 pure." },
  { tag: "Defend", tagVariant: "call", board: <>Q83 two-tone · K4<D>♦</D></>, desc: "Q-high · two-tone · K4♦", verdict: "agree", verdictText: "System agrees", system: "Key=8. Worst contain deuce. K4 with K♦ = pure play (~40 bb/100). Don't fold.", solver: "72 even with diamond unplayable. K4 with K♦ ~40 bb/100. Treacherous fold by a pro." },
]
