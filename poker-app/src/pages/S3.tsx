...
const examples: HandExample[] = [
  ...
  { tag: "Defend", tagVariant: "call", board: <>A42 two-tone</>, holeCards: <>J9<H>♥</H></>, desc: "A-high · two-tone · J9♥", verdict: "agree", verdictText: "System agrees", system: "Ignore ace/deuce. Key=4. Gutshots (3x,5x) pure. Worst contain 7 (97,T7). J9♥ high enough → pure play.", solver: "3x/5x pure calls. 97/T7 pure folds. 6 outcompetes 7. J9♥ pure confirmed." },
  ...
  { tag: "Defend", tagVariant: "call", board: <>Q83 two-tone</>, holeCards: <>K4<D>♦</D></>, desc: "Q-high · two-tone · K4♦", verdict: "agree", verdictText: "System agrees", system: "Key=8. Worst contain deuce. K4 with K♦ = pure play (~40 bb/100). Don't fold.", solver: "72 even with diamond unplayable. K4 with K♦ ~40 bb/100. Treacherous fold by a pro." },
]
