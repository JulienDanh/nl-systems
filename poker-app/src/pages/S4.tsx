...
const examples: HandExample[] = [
  ...
  { tag: "System 1 forced", tagVariant: "risk", board: <>Three Broadway, EP · T<S>♠</S>8<S>♠</S></>, desc: "Three Broadway · EP · T♠8♠", verdict: "agree", verdictText: "System agrees", system: "Linear EP = no offsuit air. Only suited hands can bluff — scarce. Pure bluff.", solver: "T8s pure bluff. No offsuit bluffs exist. 65s also pure. All equal-weight." },
  { tag: "Realism check", tagVariant: "risk", board: <>9<S>♠</S> 4<H>♥</H> 2<D>♦</D></>, desc: "9-high · BvB · 95o", verdict: "agree", verdictText: "System agrees", system: "Ideal bluffs = 4x (84,94,T4) but they had gutshots on turn → already barreled. 95o is realistically at the bottom. Pure bluff.", solver: "95o pure bluff. 84/94 were turn barrels → won't reach river. Checking 95o = no bluffing range." },
