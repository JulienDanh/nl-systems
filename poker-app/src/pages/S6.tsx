...
const examples: HandExample[] = [
  ...
  { tag: "Backdoor FD → call", tagVariant: "risk", board: <>Q75 two-tone</>, holeCards: <>Q9<H>♥</H> · ~20bb</>, desc: "Q-high · two-tone · Q9♥ · ~20bb", verdict: "agree", verdictText: "System agrees", system: "Q9o → CR. Q9♥ (BDFD) → check-call (realize flush draw).", solver: "QJ/QT pure CR; Q9 heavy (non-heart); Q9♥ → more call." },
