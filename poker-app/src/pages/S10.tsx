...
const examples: HandExample[] = [
  { tag: "Triple barrel", tagVariant: "default", board: <>Q<S>♠</S>7<S>♠</S>4<S>♠</S> → J<S>♠</S>T<S>♠</S> → blank · AQ · EP 4-way</>, desc: "Q-high · monotone · AQ · EP 4-way", verdict: "agree", verdictText: "System agrees", system: "BB called flop+turn, no raise → lack of raising = bet for value.", solver: "Triple barrel confirmed." },
  { tag: "Block bet", tagVariant: "default", board: <>Q56<H>♥</H> → 5<D>♦</D> → blank · JJ · IP checked turn</>, desc: "Q-high · monotone · JJ · IP checked turn", verdict: "agree", verdictText: "System agrees", system: "Block ~15–33%. Checking lets IP polarize. Even 3♦ flush should bet (EV bet >> check).", solver: "Blocking viable. Checking loses value." },
  { tag: "Jam", tagVariant: "default", board: <>K<S>♠</S> 4<H>♥</H> x<D>♦</D> → blank → 2<S>♠</S> (4-straight) · AK · BB checked to hero</>, desc: "K-high · two-tone · AK · 4-straight river", verdict: "agree", verdictText: "System agrees", system: "Pure jam. Checking costs ~270bb/100. Opp must call ~45% of range.", solver: "Pure jam confirmed." },
  { tag: "Bet (can't CR)", tagVariant: "default", board: <>Q<S>♠</S> 9<H>♥</H> 6<D>♦</D> → 8<D>♦</D> → T<H>♥</H> · A7 (straight) · IP checked turn</>, desc: "Q-high · two-tone · A7 straight · IP checked turn", verdict: "agree", verdictText: "System agrees", system: "Can't CR → bet to get value from medium hands. Use K-T/A-T as bluff catcher instead.", solver: "7x pure bet. Small bet, not check." },
]
