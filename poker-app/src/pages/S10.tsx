...
const examples: HandExample[] = [
  ...
  { tag: "Block bet", tagVariant: "default", board: <>Q56<H>♥</H> → 5<D>♦</D> → blank</>, holeCards: <>JJ · IP checked turn</>, desc: "Q-high · monotone · JJ · IP checked turn", verdict: "agree", verdictText: "System agrees", system: "Block ~15–33%. Checking lets IP polarize. Even 3♦ flush should bet (EV bet >> check).", solver: "Blocking viable. Checking loses value." },
