...
const examples: HandExample[] = [
  ...
  { tag: "Jam", tagVariant: "default", board: <>K4x two-tone → blank → 2<S>♠</S> (4-straight) · AK · BB checked to hero</>, desc: "K-high · two-tone · AK · 4-straight river", verdict: "agree", verdictText: "System agrees", system: "Pure jam. Checking costs ~270bb/100. Opp must call ~45% of range.", solver: "Pure jam confirmed." },
  { tag: "Bet (can't CR)", tagVariant: "default", board: <>Q96 two-tone → 8<D>♦</D> → T<H>♥</H> · A7 (straight) · IP checked turn</>, desc: "Q-high · two-tone · A7 straight · IP checked turn", verdict: "agree", verdictText: "System agrees", system: "Can't CR → bet to get value from medium hands. Use K-T/A-T as bluff catcher instead.", solver: "7x pure bet. Small bet, not check." },
]
