...
const examples: HandExample[] = [
  { tag: "River too small", tagVariant: "risk", board: <>QJx → J<D>♦</D> → blank · QJ (Q<D>♦</D>) · 80bb</>, desc: "Q-high · QJ (Q♦) · 80bb", verdict: "agree", verdictText: "System agrees", system: "Turn check (medium). River: check or bet pot. 40% is 'disastrously thin' — loses ~160–200bb/100.", solver: "No small bet exists. AJ with A♦ is minimum river barrel (pure). Queens bets pot (merge). Quarter-pot never chosen." },
